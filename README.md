...
Miro dosyasında proje yönetiminin detaylarını inceleyebilirsiniz. Zamanla güncellemeler yapılacaktır. 
...
- **Daily Scrum**: Daily Scrum toplantılarının Kullanım kolaylığından dolayı Discord üzerinden yapılmasına karar verilmiştir. Daily Scrum toplantısı örneği Miro linkinde yer almaktadır.
...
- **Sprint Review**: 
Alınan kararlar: Multiplayer temelleri oluşturulmuş, ui temelleri oluşturulmuş butonlar kodlanmıştır. Karakterin hem klavye hem de game pad ile konrol edilmesi için input system eklenmiştir. Karakter modelinin örenkleri üretilmiştir. Bulmaca mekanikleri test edilmiştir. Oyunun hikayesinin temelinde ortak karara varılmıştır. Sprint Review katılımcıları: Metin Batuhan Özücan
